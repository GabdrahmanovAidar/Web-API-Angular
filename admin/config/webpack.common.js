...
module.exports = function (options) {
    // get last tag
    // const release = childProcess.execSync('git describe --abbrev=0 --tags').toString().trim();
    ...
    return {
        ...
        module: {
            ...
            rules: [
                 ...
                 */
                {
                    ...
                    use: [
                        ...
                        { loader: 'css-loader', options: { minimize: isProd } },
                        {
                            loader: 'sass-loader',
                            options: {
                                includePaths: [helpers.root('src', 'common-styles')],
                ...
                */
                ...
                // т.к. трабл с загрузкой стилей sass и файлов для lightgallery.js (надо решить)
        ...
        plugins: [
            new SpritesmithPlugin({
                src: {
                    cwd: helpers.root('src/custom-icons'),
                    glob: '*.png'
                },
                target: {
                    image: helpers.root('src/images/sprites/sprite.png'),
                    css: [
                        [helpers.root('src/styles/custom-icons/_generated-sprite.scss'), {
                            format: 'scss'
                        }]
                    ]
                },
            ...
            new DefinePlugin({
                ...
                'process.env.BASE_API_URI': JSON.stringify(process.env.BASE_API_URI || APP_CONFIG.BASE_API_URI),
                'process.env.RAVEN_DSN': JSON.stringify(APP_CONFIG.RAVEN_DSN),
