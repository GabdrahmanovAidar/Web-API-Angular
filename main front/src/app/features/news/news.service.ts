...
import { IGrouped } from './news-list/news-list.component';
...
export class NewsService{
  ...
  public getNews(): Observable<any>{
       return this.client.get<any>(environment.apiUrl+"/news/?status=ACTIVE");
  }
  public getNewsId(id:number): Observable<any>{
    return this.client.get<any>(environment.apiUrl + "/news/" + id);
}
